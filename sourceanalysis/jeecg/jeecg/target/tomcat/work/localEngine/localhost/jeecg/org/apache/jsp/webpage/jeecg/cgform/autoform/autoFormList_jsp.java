...
public final class autoFormList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _005fjspx_005ftagPool_005ft_005fdgToolBar_0026_005ftitle_005fonclick_005ficon_005fnobody;
  ...
  public void _jspInit() {
    ...
    _005fjspx_005ftagPool_005ft_005fdgToolBar_0026_005ftitle_005fonclick_005ficon_005fnobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _005fjspx_005ftagPool_005ft_005fdgToolBar_0026_005ftitle_005fonclick_005ficon_005fnobody.release();
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write(" \t\t//给时间控件加上样式\n");
      out.write(" \t\t\t$(\"#autoFormListtb\").find(\"input[name='createDate']\").attr(\"class\",\"Wdate\").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});\n");
      out.write(" \t\t\t$(\"#autoFormListtb\").find(\"input[name='updateDate']\").attr(\"class\",\"Wdate\").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});\n");
      out.write(" });\n");
      out.write(" \n");
      ...
      if (_jspx_meth_t_005fmutiLang_005f0(_jspx_page_context))
        return;
      out.write("', \"autoFormController.do?goAdd\");\n");
      out.write("\t\t//document.location=\"autoFormController.do?goAdd\";\n");
      out.write("\t}\n");
      out.write("function updatebytab(){\n");
      out.write("var rows = $(\"#autoFormList\").datagrid(\"getSelections\");\n");
      out.write("\tif(rows==''){\n");
      out.write("\t\talert('请选择一行记录');\n");
      out.write("\t\treturn;\n");
      out.write("\t}\n");
      ...
      if (_jspx_meth_t_005fmutiLang_005f1(_jspx_page_context))
        return;
      out.write("', \"autoFormController.do?goUpdate&id=\"+id);\n");
      out.write("\t//document.location=\"autoFormController.do?goUpdate&id=\"+id;\n");
      out.write("}\n");
      out.write("var parseWindow ;\n");
      out.write("function parse(id){\n");
      out.write("\t//var targetUrl = 'autoFormController.do?parse&id='+id;\n");
      out.write("    //window.open(targetUrl,'mywin',\"menubar=0,toolbar=0,status=0,resizable=1,left=0,top=0,scrollbars=1,width=\" +(screen.availWidth-10) + \",height=\" + (screen.availHeight-50) + \"\\\"\");\n");
      out.write("\t//createdetailwindow('");
      if (_jspx_meth_t_005fmutiLang_005f2(_jspx_page_context))
        return;
      out.write("','autoFormController.do?parse&id='+id,600,400);\n");
      out.write("\tvar addurl = 'autoFormController.do?parse&id='+id;\n");
      out.write("\tparseWindow = $.dialog({\n");
      ...
      out.write("}\n");
      out.write("\n");
      out.write("function dbconfig(id){\n");
      out.write("\taddOneTab( '表单数据源配置', \"autoFormDbController.do?autoFormDb&autoFormId=\"+id);\n");
      out.write("}\n");
      out.write("\n");
      out.write("function winclose(){\n");
      out.write("\tparseWindow.close();\n");
      out.write("\tparseWindow = undefined;\n");
      out.write("}\n");
      out.write("\n");
      out.write(" </script>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_t_005fbase_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(3,0) name = type type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdatagrid_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(6,2) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setName("autoFormList");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(6,2) name = checkbox type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setCheckbox(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(6,2) name = fitColumns type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setFitColumns(false);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(6,2) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setTitle("自定义表单列表");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(6,2) name = actionUrl type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setActionUrl("autoFormController.do?datagrid");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(6,2) name = idField type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setIdField("id");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(6,2) name = fit type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setFit(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(6,2) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(7,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f0.setTitle("");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(7,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f0.setField("id");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(7,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f0.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(7,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f0.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(7,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(8,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f1.setTitle("auto.form.formName");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(8,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f1.setField("formDesc");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(8,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f1.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(8,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f1.setWidth(new Integer(300));
  ...
  private boolean _jspx_meth_t_005fdgCol_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(9,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f2.setTitle("auto.form.formCode");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(9,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f2.setField("formName");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(9,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f2.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(9,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f2.setWidth(new Integer(300));
  ...
  private boolean _jspx_meth_t_005fdgCol_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(10,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f3.setTitle("");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(10,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f3.setField("formStyleId");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(10,3) name = dictionary type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f3.setDictionary("auto_form_style,id,style_desc");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(10,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f3.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(10,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f3.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(10,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_th_t_005fdgCol_005f3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005ft_005fdgCol_0026_005fwidth_005ftitle_005fqueryMode_005fhidden_005ffield_005fdictionary_005fnobody.reuse(_jspx_th_t_005fdgCol_005f3);
      return true;
    }
    _005fjspx_005ftagPool_005ft_005fdgCol_0026_005fwidth_005ftitle_005fqueryMode_005fhidden_005ffield_005fdictionary_005fnobody.reuse(_jspx_th_t_005fdgCol_005f3);
    return false;
  ...
  private boolean _jspx_meth_t_005fdgCol_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(11,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f4.setTitle("common.createName");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(11,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f4.setField("createName");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(11,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f4.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(11,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f4.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(11,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(12,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f5.setTitle("common.createby");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(12,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f5.setField("createBy");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(12,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f5.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(12,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f5.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(12,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(13,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f6.setTitle("common.createDate");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(13,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f6.setField("createDate");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(13,3) name = formatter type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f6.setFormatter("yyyy-MM-dd");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(13,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f6.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(13,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f6.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(13,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(14,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f7.setTitle("common.updateName");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(14,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f7.setField("updateName");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(14,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f7.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(14,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f7.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(14,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(15,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f8.setTitle("common.updateBy");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(15,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f8.setField("updateBy");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(15,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f8.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(15,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f8.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(15,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(16,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f9.setTitle("common.updateDate");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(16,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f9.setField("updateDate");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(16,3) name = formatter type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f9.setFormatter("yyyy-MM-dd");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(16,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f9.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(16,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f9.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(16,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(17,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f10.setTitle("common.depart.code");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(17,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f10.setField("sysOrgCode");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(17,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f10.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(17,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f10.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(17,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(18,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f11.setTitle("common.company.code");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(18,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f11.setField("sysCompanyCode");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(18,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f11.setHidden(true);
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(18,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f11.setQueryMode("single");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(18,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(19,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f12.setTitle("common.operation");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(19,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f12.setField("opt");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(19,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f12.setWidth(new Integer(400));
  ...
  private boolean _jspx_meth_t_005fdgDelOpt_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(20,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgDelOpt_005f0.setTitle("common.delete");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(20,3) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgDelOpt_005f0.setUrl("autoFormController.do?doDel&id={id}");
  ...
  private boolean _jspx_meth_t_005fdgFunOpt_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(21,4) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgFunOpt_005f0.setTitle("表单数据源配置");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(21,4) name = funname type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgFunOpt_005f0.setFunname("dbconfig(id)");
  ...
  private boolean _jspx_meth_t_005fdgFunOpt_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(22,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgFunOpt_005f1.setTitle("autoform.preview");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(22,3) name = funname type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgFunOpt_005f1.setFunname("parse(id)");
  ...
  private boolean _jspx_meth_t_005fdgToolBar_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  t:dgToolBar
    org.jeecgframework.tag.core.easyui.DataGridToolBarTag _jspx_th_t_005fdgToolBar_005f0 = (org.jeecgframework.tag.core.easyui.DataGridToolBarTag) _005fjspx_005ftagPool_005ft_005fdgToolBar_0026_005ftitle_005fonclick_005ficon_005fnobody.get(org.jeecgframework.tag.core.easyui.DataGridToolBarTag.class);
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(23,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f0.setTitle("设计新表单");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(23,3) name = icon type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f0.setIcon("icon-add");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(23,3) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f0.setOnclick("addbytab()");
    ...
    if (_jspx_th_t_005fdgToolBar_005f0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005ft_005fdgToolBar_0026_005ftitle_005fonclick_005ficon_005fnobody.reuse(_jspx_th_t_005fdgToolBar_005f0);
      return true;
    }
    _005fjspx_005ftagPool_005ft_005fdgToolBar_0026_005ftitle_005fonclick_005ficon_005fnobody.reuse(_jspx_th_t_005fdgToolBar_005f0);
    return false;
  ...
  private boolean _jspx_meth_t_005fdgToolBar_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  t:dgToolBar
    org.jeecgframework.tag.core.easyui.DataGridToolBarTag _jspx_th_t_005fdgToolBar_005f1 = (org.jeecgframework.tag.core.easyui.DataGridToolBarTag) _005fjspx_005ftagPool_005ft_005fdgToolBar_0026_005ftitle_005fonclick_005ficon_005fnobody.get(org.jeecgframework.tag.core.easyui.DataGridToolBarTag.class);
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(24,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f1.setTitle("编辑表单");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(24,3) name = icon type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f1.setIcon("icon-edit");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(24,3) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f1.setOnclick("updatebytab()");
    ...
    if (_jspx_th_t_005fdgToolBar_005f1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005ft_005fdgToolBar_0026_005ftitle_005fonclick_005ficon_005fnobody.reuse(_jspx_th_t_005fdgToolBar_005f1);
      return true;
    }
    _005fjspx_005ftagPool_005ft_005fdgToolBar_0026_005ftitle_005fonclick_005ficon_005fnobody.reuse(_jspx_th_t_005fdgToolBar_005f1);
    return false;
  ...
  private boolean _jspx_meth_t_005fdgToolBar_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(25,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f2.setTitle("common.batch.delete");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(25,3) name = icon type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f2.setIcon("icon-remove");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(25,3) name = url type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f2.setUrl("autoFormController.do?doBatchDel");
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(25,3) name = funname type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fmutiLang_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(38,17) name = langKey type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fmutiLang_005f0.setLangKey("auto.form.addorupdate");
  ...
  private boolean _jspx_meth_t_005fmutiLang_005f1(PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(48,13) name = langKey type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fmutiLang_005f1.setLangKey("auto.form.addorupdate");
  ...
  private boolean _jspx_meth_t_005fmutiLang_005f2(PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(55,23) name = langKey type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fmutiLang_005f2.setLangKey("common.view");
  ...
  private boolean _jspx_meth_t_005fmutiLang_005f3(PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/autoform/autoFormList.jsp(62,10) name = langKey type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fmutiLang_005f3.setLangKey("common.view");

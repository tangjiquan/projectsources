...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
  ...
  private boolean _jspx_meth_t_005fmutiLang_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/system/log/userBroswerLine.jsp(21,15) name = langKey type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

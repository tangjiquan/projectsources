...
public final class jformInnerMailReceiveList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("  </div>\n");
      out.write(" </div>\n");
      out.write(" <script src = \"webpage/com/buss/core/jformInnerMailList.js\"></script>\t\t\n");
      out.write(" <script type=\"text/javascript\">\n");
      out.write(" $(document).ready(function(){\n");
      out.write(" \t\t//给时间控件加上样式\n");
      out.write(" \t\t\t$(\"#jformInnerMailListtb\").find(\"input[name='createDate']\").attr(\"class\",\"Wdate\").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});\n");
      out.write(" \t\t\t$(\"#jformInnerMailListtb\").find(\"input[name='updateDate']\").attr(\"class\",\"Wdate\").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});\n");
      out.write(" });\n");
      out.write(" function goDetail(title,url,id){\n");
      ...
      out.write("\t\t}\n");
      out.write("\t\tdebugger;\n");
      out.write("\t\turl = url +'&id='+rowsData[0].mailId;\n");
      out.write("\t\tcreatedetailwindow(\"写信\", url)\n");
      out.write(" }\n");
      out.write(" function goAddOrUpdate(title,url, id){\n");
      out.write("\t\tvar rowsData = $('#'+id).datagrid('getSelections');\n");
      out.write("\t\tif (!rowsData || rowsData.length==0) {\n");
      out.write("\t\t\ttip('请选择编辑项目');\n");
      out.write("\t\t\treturn;\n");
      ...
      out.write("\t\t}\n");
      out.write("\t\tdebugger;\n");
      out.write("\t\turl = url +'&id='+rowsData[0].id;\n");
      out.write("\t\taddOneTab(\"写信\", url)\n");
      out.write("\t}\n");
      out.write(" </script>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_t_005fbase_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(3,0) name = type type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdatagrid_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(6,2) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setName("jformInnerMailList");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(6,2) name = checkbox type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setCheckbox(true);
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(6,2) name = fitColumns type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setFitColumns(false);
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(6,2) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setTitle("收件箱");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(6,2) name = actionUrl type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setActionUrl("jformInnerMailController.do?getReceivedMails");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(6,2) name = idField type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setIdField("id");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(6,2) name = fit type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdatagrid_005f0.setFit(true);
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(6,2) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(7,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f0.setTitle("主键");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(7,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f0.setField("id");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(7,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f0.setHidden(true);
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(7,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f0.setQueryMode("single");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(7,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(8,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f1.setTitle("邮件ID");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(8,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f1.setField("mailId");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(8,3) name = hidden type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f1.setHidden(true);
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(8,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f1.setQueryMode("single");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(8,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(9,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f2.setTitle("主题");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(9,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f2.setField("title");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(9,3) name = query type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f2.setQuery(true);
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(9,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f2.setQueryMode("single");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(9,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(10,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f3.setTitle("发件人名称");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(10,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f3.setField("senderName");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(10,3) name = query type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f3.setQuery(true);
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(10,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f3.setQueryMode("single");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(10,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(11,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f4.setTitle("发件人账号");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(11,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f4.setField("senderAccount");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(11,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f4.setQueryMode("single");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(11,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(12,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f5.setTitle("日期");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(12,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f5.setField("sendTime");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(12,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f5.setQueryMode("single");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(12,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(13,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f6.setTitle("状态");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(13,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f6.setField("status");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(13,3) name = queryMode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f6.setQueryMode("single");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(13,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgCol_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(14,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f7.setTitle("操作");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(14,3) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgCol_005f7.setField("opt");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(14,3) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fdgDelOpt_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(15,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgDelOpt_005f0.setTitle("删除");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(15,3) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgDelOpt_005f0.setUrl("jformInnerMailController.do?doDelReceivedMail&id={id}");
  ...
  private boolean _jspx_meth_t_005fdgToolBar_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(16,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f0.setTitle("查看");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(16,3) name = icon type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f0.setIcon("icon-search");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(16,3) name = url type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f0.setUrl("jformInnerMailController.do?goDetail");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(16,3) name = funname type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f0.setFunname("goDetail");
  ...
  private boolean _jspx_meth_t_005fdgToolBar_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005fdatagrid_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(17,3) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f1.setTitle("删除");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(17,3) name = icon type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f1.setIcon("icon-remove");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(17,3) name = url type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdgToolBar_005f1.setUrl("jformInnerMailController.do?doDelReceivedMails");
    // /webpage/system/mail/jformInnerMailReceiveList.jsp(17,3) name = funname type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
